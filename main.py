        """
        Stream Parser 0ktskv
        ====================
        Data engineering tool to clean structured datasets with zero hassle.
...
def _write_output(rows: list, path: Path, suffix: str) -> None:
    ...
    if suffix == ".csv" and rows:
        ...
        def build_parser() -> argparse.ArgumentParser:
            p = argparse.ArgumentParser(prog=APP_NAME, description="Data engineering tool to clean structured datasets with zero hassle.")
